...
<body class="theme-light preload-active aside-active aside-mobile-minimized aside-desktop-maximized" id="fullscreen">
	...
	<div class="holder">
		<div class="aside">
			<div class="aside-header mt-2 logo-width">
				<div class="aside-title mb-2">
					<a href="{{ route('dashboard') }}" class="aside-title">
						<h4>{{ config('app.name') }}</h4>
						{{-- <img src="{{ asset('assets/themes/panely/assets/images/logo/farmapos.png') }}" alt="Logo" class="img-fluid" style="max-height: 6.6rem"> --}}
					</a>
				</div>
				<div class="aside-addon">
					<button class="btn bg-orange btn-icon btn-lg" data-toggle="aside" onmouseup="adjust_col()">

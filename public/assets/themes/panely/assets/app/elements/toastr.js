...
$(function () {
    ...
    $("#showtoast").click(function () {
        ...
        var msg = $("#message").val() || getMessage();
        var title = $("#title").val() || "";
        var showDuration = $("#showDuration").val();
        var hideDuration = $("#hideDuration").val();
        var timeOut = $("#timeOut").val();
        var extendedTimeOut = $("#extendedTimeOut").val();
        var showEasing = $("#showEasing").val();
        var hideEasing = $("#hideEasing").val();
        var showMethod = $("#showMethod").val();
        var hideMethod = $("#hideMethod").val();
        var addBehaviorToastClick = $("#addBehaviorOnToastClick").prop("checked");
        ...
        var optionText = "toastr.options = ".concat(JSON.stringify(toastr.options, null, 4));
        var commandText = "toastr."
            .concat(shortCutFunction, '("')
            .concat(msg, '"')
            .concat(title ? ', "' + title + '"' : "", ")");
        $("#toastrOptions").text("".concat(optionText, "\n\n").concat(commandText));
